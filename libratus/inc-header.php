...
if ($_current_album && $_gallery_page != 'favorites.php' && $_gallery_page != '404.php') {
$randomImage = getRandomImagesAlbum($_current_album);
} else {
...
<head>
	...
	<link rel="stylesheet" href="<?php echo $_themeroot; ?>/css/normalize.css">
	<link rel="stylesheet" href="<?php echo $_themeroot; ?>/css/skeleton.css">
	<link rel="stylesheet" href="<?php echo $_themeroot; ?>/css/font-awesome.min.css" type="text/css" />
	<link href="//fonts.googleapis.com/css?family=Raleway:400,300,600" rel="stylesheet" type="text/css">
	<link rel="stylesheet" href="<?php echo $_themeroot; ?>/css/pushy.css">
	<link rel="stylesheet" href="<?php echo $_themeroot; ?>/css/ss.css" />

	<link rel="stylesheet" href="<?php echo $_themeroot; ?>/js/swipebox/css/swipebox.css" />
	<link rel="stylesheet" href="<?php echo $_themeroot; ?>/js/justifiedgallery/justifiedGallery.min.css" />
	<link rel="stylesheet" href="<?php echo $_themeroot; ?>/css/style.css">

	<script src="<?php echo $_themeroot; ?>/js/modernizr.custom.js"></script>

	<link rel="shortcut icon" href="<?php echo $_themeroot; ?>/images/favicon.ico">
	<link rel="apple-touch-icon-precomposed" href="<?php echo $_themeroot; ?>/images/favicon-152.png">
	<meta name="msapplication-TileColor" content="#ffffff">
	<meta name="msapplication-TileImage" content="<?php echo $_themeroot; ?>/images/favicon-144.png">
...
<body>
	...
	<script>
		...
		ga('create', '<?php echo getOption('libratus_analytics'); ?>', 'auto');
		ga('send', 'pageview');
		<?php } else { ?>
		var _gaq = _gaq || [];

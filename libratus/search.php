				...
				<div class="gallery pad">
					...
					while (next_page()) { ?>
						<div class="one-half column">
							<div class="news-clip">
								<div class="bold-header"><a href="<?php echo html_encode($_CMS_current_page->getLink()); ?>"><?php printPageTitle(); ?></a> <small><em><i title="<?php echo gettext('Page Result'); ?>" class="fa fa-copy fa-fw"></i></em></small></div>
